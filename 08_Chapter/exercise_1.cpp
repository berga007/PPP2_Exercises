...
// Modify the calculator program (below)

// This program adds some improvements to the calculator program
// "Programming - Principles and Practice using C++" by Bjarne Stroustrup
// The feature (allowing ! operations) is added on top of my_calculator.cpp
...
public:
    ...
    Token_stream(istream& custom_stream): cin{custom_stream} { } 
...
double primary_function(Token_stream& ts)
{
    Token t = ts.get();
...
double sub_term(Token_stream& ts)
{
    double left = primary_function(ts);
    Token t = ts.get();
    switch(t.kind){
        case '!':
        {
